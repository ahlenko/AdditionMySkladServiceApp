package com.example.additionapp.checkers;
...
public class InputChecker {
    ...
    public static boolean isNotPIB(String str, TextView text, int max, AppCompatActivity a) {
        if (str.length() > max && !str.matches("^[a-zA-Zа-яА-ЯґҐєЄіІїЇ\\s'-]*$")){
            text.setTextColor(a.getResources().getColor(R.color.red_note));
            return true;
        } return false;
    }
